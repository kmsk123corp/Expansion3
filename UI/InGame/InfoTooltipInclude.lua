...
function GetHelpTextForUnit(iUnitID, bIncludeRequirementsInfo)
	...
	if(pUnitInfo.Cost > 0) then
		strHelpText = strHelpText .. Locale.ConvertTextKey("TXT_KEY_PRODUCTION_COST", pActivePlayer:GetUnitProductionNeeded(iUnitID));
          -- strHelpText = strHelpText .. string.format("[COLOR:190:190:190:200]" .. Locale.ConvertTextKey("TXT_KEY_PRODUCTION_COST", pActivePlayer:GetUnitProductionNeeded(iUnitID)) .. "[/COLOR]");
	end
     ...
     for pResource in GameInfo.Resources() do
          ...
          iNumResourceNeeded = Game.GetNumResourceCostForUnit(iUnitID, iResourceID);
          if (iNumResourceNeeded > 0) then
               -- First resource required
               if (iNumResourcesNeededSoFar == 0) then
                    strHelpText = strHelpText .. "[NEWLINE]";
                    strHelpText = strHelpText .. string.format("[COLOR:195:195:195:255]" .. Locale.ConvertTextKey("TXT_KEY_PRODUCTION_COST_REQUIRED") .. "[/COLOR]");
                    -- strHelpText = strHelpText .. " " .. iNumResourceNeeded .. " " .. pResource.IconString .. " " .. Locale.ConvertTextKey(pResource.Description);
               else
                    -- strHelpText = strHelpText .. ", " .. iNumResourceNeeded .. " " .. pResource.IconString .. " " .. Locale.ConvertTextKey(pResource.Description);
               end

               strHelpText = strHelpText .. "[NEWLINE] " .. iNumResourceNeeded .. " " .. pResource.IconString .. " " .. Locale.ConvertTextKey(pResource.Description);
     ...
     for pResource in GameInfo.Resources() do
          ...
          if (iNumResourceNeeded > 0) then
               ...
               if (iNumResourcesNeededSoFar == 0) then
                    ...
                    strHelpText = strHelpText .. string.format("[COLOR:195:195:195:255]" .. Locale.ConvertTextKey("TXT_KEY_PRODUCTION_RESOURCES_REQUIRED") .. "[/COLOR]");
...
function GetHelpTextForBuilding(iBuildingID, bExcludeName, bExcludeHeader, bNoMaintenance, pCity)
	...
	if (not bExcludeHeader) then
		...
		if(pBuildingInfo.Cost > 0) then
          ...
          for pResource in GameInfo.Resources() do
               iResourceID = pResource.ID;
               iNumResourceNeeded = Game.GetNumResourceCostForBuilding(iBuildingID, iResourceID);
               if (iNumResourceNeeded > 0) then
                    -- First resource required
                    if (iNumResourcesNeededSoFar == 0) then
                         strHelpText = strHelpText .. "[NEWLINE]";
          ...
          -- Произдовство ресурсах
          local iNumResourcesNeededSoFar = 0;
          local iNumResourceNeeded;
          local iResourceID;
          for pResource in GameInfo.Resources() do
               iResourceID = pResource.ID;
               iNumResourceNeeded = Game.GetNumResourceProducesForBuilding(iBuildingID, iResourceID);
               if (iNumResourceNeeded > 0) then
                    -- First resource required
                    if (iNumResourcesNeededSoFar == 0) then
                         strHelpText = strHelpText .. "[NEWLINE]";
                         strHelpText = strHelpText .. string.format("[COLOR:195:195:195:255]" .. Locale.ConvertTextKey("TXT_KEY_PRODUCTION_RESOURCES_PRODUCES") .. "[/COLOR]");
                    end
