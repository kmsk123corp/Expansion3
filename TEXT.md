...
Дромон (Dromon) (Ключевой корабль Византийской империи)

    Годы: VI век н.э. - XV век н.э. (расцвет в VII-XII веках).
    Водоизмещение: 50-120 тонн (разные размеры).
    Вес: 20-50 тонн (зависит от размера).
    Длина: 20-40 метров.
    Трудозатраты: 120 рабочих.
    Число весел: 50-100 (зависит от размера).
    Число рядов весел: 1-2.
    Число мачт: 1-2.
    Число парусов: 1-2 (латинские).
    Технологические требования:
        Технология: “Византийское судостроение” (Требует знания улучшенной обработки дерева, морской навигации и “греческого огня”).
        Ресурсы: Дерево (220), Железо (80), Нефть (50 - для “греческого огня”), пища (80).
    Уникальные способности:
        “Греческий огонь” - мощное оружие, наносящее урон вражеским кораблям на расстоянии.
        Высокая маневренность и скорость.
    Тактика:
        Уничтожение вражеских кораблей с помощью “греческого огня”.
        Защита побережья и торговых путей.
        Быстрые рейды.
    Баланс:
        “Греческий огонь” имеет ограниченный запас и требует перезарядки.
        Уязвимость к абордажу.
    Пример: Византийская империя.

Снекка (Snekkja) / Драккар (Drakkar) (Корабли викингов)

    Годы: VIII век н.э. - XIII век н.э.
    Водоизмещение: 20-60 тонн (в среднем).
    Вес: 10-30 тонн.
    Длина: 15-30 метров.
    Трудозатраты: 80 рабочих.
    Число весел: 20-30.
    Число рядов весел: 1.
    Число мачт: 1.
    Число парусов: 1 (прямоугольный).
    Технологические требования:
        Технология: “Скандинавское судостроение” (Требует знания строительства клинкерных кораблей и навигации в сложных условиях).
        Ресурсы: Дерево (180), Железо (50), Смола (30), пища (60).
    Уникальные способности:
        Высокая скорость и маневренность в узких реках и фьордах.
        Способность высаживаться на мелководье.
        Устрашающий вид (бонус к морали вражеских войск).
    Тактика:
        Быстрые набеги на побережья.
        Плавание по рекам вглубь вражеской территории.
        Морской разбой.
    Баланс:
        Небольшая вместимость.
        Уязвимость в открытом море при сильном ветре.
    Пример: Викинги (Норвегия, Дания, Швеция).

Арабский Дхау (Dhow)

    Годы: VII век н.э. - настоящее время (пик в X-XV веках) * Водоизмещение: 50-200 тонн (в среднем) * Вес: 20-80 тонн * Длина: 20-40 метров * Трудозатраты: 90 рабочих. * Число весел: 0 (используются только для маневрирования в порту) * Число рядов весел: 0 * Число мачт: 1-3 * Число парусов: 1-3 (латинские)
    Технологические требования:
        Технология: «Арабская навигация»
        Ресурсы: Дерево (200), парусина (100), железо (50)
    Уникальные способности:
        Высокая скорость под парусами при попутном ветре.
        Способность плавать на дальние расстояния.
        Бонус к торговле.
    Тактика:
        Торговля.
        Перевозка грузов.
        Разведка.
    Баланс:
        Уязвимость в бою с военными кораблями.
        Полная зависимость от ветра.
