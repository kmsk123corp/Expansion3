...
ScenarioCivilizations = {
	[0] = "CIVILIZATION_MONGOL",
	[1] = "CIVILIZATION_CHINA",
	[2] = "CIVILIZATION_JAPAN",
	[3] = "CIVILIZATION_KOREA",
}
...
Controls.StartButton:RegisterCallback(Mouse.eLClick, function()
	...
	local myModId = "24081928-4703-4845-8b9c-c1468a8cacf2";
	local myModVersion = Modding.GetActivatedModVersion(myModId);
	local scenarioMap = Modding.GetEvaluatedFilePath(myModId, myModVersion, "KoreaScenario.Civ5Map");
...
function SetPlayerIndex(playerIndex)
	...
	if(playerIndex ~= nil) then
		...
		-- Sets Dawn of Man Quote
		Controls.Quote:LocalizeAndSetText("TXT_KEY_KOREA_SCENARIO_CIV5_DAWN_KOREA_TEXT");		
    end
