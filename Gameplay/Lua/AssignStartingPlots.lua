...
function AssignStartingPlots:AddStrategicBalanceResources(region_number)
	...
	local uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = self:GetMajorStrategicResourceQuantityValues()
	local shuf_list;
...
function AssignStartingPlots:PlaceSmallQuantitiesOfStrategics(frequency, plot_list)
	...
	local uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = self:GetSmallStrategicResourceQuantityValues()
...
function AssignStartingPlots:GetMajorStrategicResourceQuantityValues()
	...
	local uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = 4, 4, 10, 10, 20, 20, 5;
	-- Check the resource setting.
	if self.resource_setting == 1 then -- Sparse
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = 2, 4, 5, 4, 5, 5, 5;
	elseif self.resource_setting == 3 then -- Abundant
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = 4, 6, 9, 9, 5, 10, 5;
	end
	return uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt
end
------------------------------------------------------------------------------
function AssignStartingPlots:GetSmallStrategicResourceQuantityValues()
	...
	local uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = 2, 2, 5, 5, 10, 10, 2;
	-- Check the resource setting.
	if self.resource_setting == 1 then -- Sparse
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = 1, 1, 2, 1, 2, 2, 2;
	elseif self.resource_setting == 3 then -- Abundant
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt = 3, 3, 3, 3, 3, 3, 2;
	end
	return uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt, copper_amt
end
------------------------------------------------------------------------------
function AssignStartingPlots:PlaceStrategicAndBonusResources()
    ...
    {self.copper_ID, copper_amt, 20, 0, 2},
	...
	local resources_to_place = {
	{self.coal_ID, coal_amt, 30, 1, 2},
    {self.copper_ID, copper_amt, 20, 1, 2},
	...
	local resources_to_place = {
    {self.copper_ID, copper_amt, 30, 1, 2},
    ...
    if self.amounts_of_resources_placed[self.copper_ID + 1] < 4 * self.iNumCivs then
		print("Карта содержит очень мало меди, добавляя еще один.");
